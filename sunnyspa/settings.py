"""
Django settings for sunnyspa project.
...
SECRET_KEY = 'ddzjd-(o!wm2bpi=)^ov2a_-%iw8+&-n_=)h2qk%j2hfh4+*9%'
...
WSGI_APPLICATION = 'sunnyspa.wsgi.application'
